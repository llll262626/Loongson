...
QT_MOC_LITERAL(1, 7, 12), // "Signal_Error"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5) // "index"

    },
    "MyWork\0Signal_Error\0\0index"
};
...
void MyWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_Error((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWork::Signal_Error)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyWork::Signal_Error(int _t1)
{
